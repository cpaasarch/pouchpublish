...
install_pouch() {
  ...
  git clone "https://github.com/cpaasarch/pouch.git" "${gopath}/src/${pkg_name}"
...
main() {
  ...
  cp /usr/local/bin/containerd-shim "${dist_dir}/usr/local/bin"
  cp /usr/local/bin/containerd "${dist_dir}/usr/local/bin"
  cp /usr/local/bin/ctr "${dist_dir}/usr/local/bin"
  cp /usr/local/bin/runc "${dist_dir}/usr/local/bin"
